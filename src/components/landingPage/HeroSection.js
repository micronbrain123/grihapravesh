...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pb-10">
      {/* Animated Background with Custom Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-orange-500/90 via-red-600/80 to-orange-600/90"></div>
      
      {/* Dynamic Background Pattern */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-20 left-20 w-72 h-72 bg-white rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
        <div 
          className="absolute top-40 right-20 w-96 h-96 bg-orange-400 rounded-full mix-blend-multiply filter blur-xl animate-pulse [animation-delay:2s]"
        ></div>
        <div 
          className="absolute -bottom-20 left-40 w-80 h-80 bg-red-400 rounded-full mix-blend-multiply filter blur-xl animate-pulse [animation-delay:4s]"
        ></div>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
        <div className="animate-pulse">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-8 leading-tight">
            ...
            <span 
              className="block bg-gradient-to-r from-orange-400 via-red-400 to-orange-500 bg-clip-text text-transparent animate-pulse [animation-delay:0.5s]"
            >
              Dream Home
            </span>
          </h1>
          ...
          <div className="max-w-4xl mx-auto mb-12 animate-pulse [animation-delay:1.1s]">
            <div className="relative group">
              <div 
                className="absolute inset-0 bg-gradient-to-r from-orange-500 to-red-600 rounded-2xl blur opacity-75 group-hover:opacity-100 transition duration-300"
              ></div>
                ...
                <div className="flex flex-col md:flex-row gap-2">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-4 text-lg rounded-xl border-0 focus:outline-none focus:ring-2 focus:ring-orange-500 bg-transparent placeholder-gray-500"
                    />
                  </div>
                  <button 
                    className="group relative px-8 py-4 bg-gradient-to-r from-orange-500 to-red-600 text-white rounded-xl font-semibold text-lg transition-all duration-300 hover:from-orange-600 hover:to-red-700 hover:shadow-lg hover:scale-105 active:scale-95"
                  >
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-16 animate-pulse [animation-delay:1.4s]">
            <button 
              className="group relative px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-full font-medium transition-all duration-300 hover:shadow-lg hover:scale-110 active:scale-95"
            >
              <div className="flex items-center gap-2">
                <div className="group-hover:rotate-12 transition-transform duration-300">
                  <HomeIcon />
            ...
            <button 
              className="group relative px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-full font-medium transition-all duration-300 hover:shadow-lg hover:scale-110 active:scale-95"
            >
              <div className="flex items-center gap-2">
                <div className="group-hover:rotate-12 transition-transform duration-300">
                  <MapPinIcon />
            ...
            <button 
              className="group relative px-6 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-full font-medium transition-all duration-300 hover:shadow-lg hover:scale-110 active:scale-95"
            >
              <div className="flex items-center gap-2">
                <div className="group-hover:rotate-12 transition-transform duration-300">
                  <TrendingUpIcon />
