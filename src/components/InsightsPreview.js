      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-100 to-purple-100 border border-blue-200/50 mb-4">
            <InsightIcon />
            <span className="text-blue-800 text-sm font-medium ml-2">Market Intelligence</span>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['Market Analysis', 'Investment Tips', 'Price Trends', 'Home Loans', 'Legal Guide', 'Property Reviews'].map((tag, idx) => (
              <a 
                ...
                className="px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-gray-200 text-gray-600 hover:text-white hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-600 hover:border-transparent transition-all duration-300 hover:scale-105 hover:shadow-lg text-sm font-medium"
